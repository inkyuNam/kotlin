...
fun main() {
    ...
    println("-------------------------------------------------------")
    // 기타 메서드
    // indexOf : 지정된 값의 인덱스 번호를 반환한다. 값이 없을 경우 -1 을 반환
    ...
    list3.addAll(listOf(40,50,60))  // 가변 리스트에 요소를 한 번에 여러 개 추가
    println("list3 : $list3")

    list3.add(1,100) // 특정 인덱스에 데이터 추가, 뒤에 요소를 한칸씩 민다.
    println("list3 : $list3")
    list3.addAll(2, listOf(200,300,400)) // 특정 인덱스에 데이터를 여러 개 한 번에 추가 뒤에 요소를 한칸씩 민다.
    println("list3 : $list3")
    list3.remove(100)   // 리스트 요소중 해당 값을 한개 또는 여러 개 제거
    println("list3 : $list3")
    list3.removeAll(listOf(200,300))
    println("list3 : $list3")
    list3.removeAt(1) // 지정한 인덱스의 요소를 삭제
    println("list3 : $list3")
    list3.set(1,200) // 지정한 인덱스에 지정한 값으로 수정
    println("list3 : $list3")
    ...
    // list1.add(1000) // 불변형이기 때문에 요소 추가는 에러
